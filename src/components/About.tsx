...
const About = () => {
  return (
    <main id='About' className='w-full flex md:flex-row flex-col-reverse justify-center items-center lg:px-20 sm:px-10 px-5 md:gap-5 gap-10 py-16'>
      ...
      <h1 className="text-[#457b9d] sm:text-2xl text-xl font-semibold ">About</h1>
      <h1 className='lg:text-5xl text-4xl font-bold'>About Me?</h1>
